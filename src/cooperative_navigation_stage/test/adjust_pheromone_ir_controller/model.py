...
class Actor(nn.Module):
    def __init__(self, n_states, n_actions):
        ...
        self.fc_pheromone_radius = nn.Linear(in_features=128, out_features=1)
    ...
    def forward(self, x):
        ...
        mean_pheromone_radius = torch.tanh(self.fc_pheromone_radius(x))
        
        mean = torch.cat([mean_linear, mean_angular, mean_pheromone_radius], dim=-1)     
