...
def main():
    ...
    agent = PPOAgent(env_name=gazebo_env.env_name,
    ...
    # load_path = \
    # "/home/nishilab/catkin_ws/src/pheromone_navigation/src/cooperative_navigation_stage/test/pheromone_ir_controller/ppo_Gazebo_Cooperative_Navigation_Pheromoone_IR/2024-01-26_03-47-02"
    # load_iteration = 170
    ...
    for _ in range(agent.iteration, total_iterations):
        ...
        if agent.iteration % plot_interval == 0:
            agent.logger.plot_graph(agent.iteration)
